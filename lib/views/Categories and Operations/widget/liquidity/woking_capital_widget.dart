...
class WorkingCapitalWidget extends StatefulWidget {
  const WorkingCapitalWidget({Key? key, required this.name}) : super(key: key);
  final String name;

  @override
  State<WorkingCapitalWidget> createState() => _WorkingCapitalWidgetState();
}

class _WorkingCapitalWidgetState extends State<WorkingCapitalWidget> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        const ImageWidget(name: "workingCapitalRatios"),
        const SizedBox(
          height: 10,
        ),
        SizedBox(
