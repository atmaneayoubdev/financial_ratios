...
class CachRatioWidget extends StatefulWidget {
  const CachRatioWidget({Key? key, required this.name}) : super(key: key);
  final String name;

  @override
  State<CachRatioWidget> createState() => _CachRatioWidgetState();
}

class _CachRatioWidgetState extends State<CachRatioWidget> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        const ImageWidget(name: "cachRatios"),
        const SizedBox(
          height: 10,
        ),
        SizedBox(
