...
class CfoToInterest extends StatefulWidget {
  const CfoToInterest({Key? key}) : super(key: key);

  @override
  State<CfoToInterest> createState() => _CfoToInterestState();
}

class _CfoToInterestState extends State<CfoToInterest> {
  double result = 0;
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        const ImageWidget(name: "cfoToInterest"),
        const SizedBox(
          height: 10,
        ),
        SizedBox(
