...
class TimesIntrestEarnedWidget extends StatefulWidget {
  const TimesIntrestEarnedWidget({Key? key}) : super(key: key);

  @override
  State<TimesIntrestEarnedWidget> createState() =>
      _TimesIntrestEarnedWidgetState();
}

class _TimesIntrestEarnedWidgetState extends State<TimesIntrestEarnedWidget> {
  double result = 0;
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        const ImageWidget(name: "timesInterestEarned"),
        const SizedBox(
          height: 10,
        ),
        SizedBox(
